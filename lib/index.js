...
const bundleAPK = require('./apkAction/bundleAPK');
...
program.on( '--help', function () {
    ...
    console.log( '  $ zrn bundle -t <ios|android> [-c <config path>] [-d]  --->  构建项目，不传-t默认ios和android一起构建' );
    console.log( '  $ zrn update  --->  更新依赖，devDependencies和dependencies依赖包的版本' );
    console.log( '  $ zrn bundle-apk  --->  构建安卓apk' );
    console.log( '  $ zrn install-apk [-c <config path>] --->  安装apk到设备' );
    console.log( '' );
    warmPrompt();
